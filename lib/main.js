...
exports.main = function() {
  ...
  var getBackgroundColor = function(id) {
    ...
    if ((low_id.indexOf("worldcoin") != -1) || (low_id.indexOf("dogecoin") != -1) || 
      ...
      if (getBooleanPreference("other-background")) {
        ...
        } else if (low_id.indexOf("bitshares") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.bitshares;
        }
      }
  ...
  // Bitshares prices //
  ticker_creators['BterBitshares'] = function() { return createTicker('BterBitshares', 'Bter', '\u0243', 'BTS', '#000', "http://data.bter.com/api/1/ticker/bts_btc", ['last']); };
  registerEvents('BterBitshares');
