...
tickers['PreludeAuroracoinUSD'] = null;
...
exports.main = function() {
  ...
  var getBackgroundColor = function(id) {
    if ((id.toLowerCase().indexOf("worldcoin") != -1) || (id.toLowerCase().indexOf("dogecoin") != -1) || 
        (id.toLowerCase().indexOf("namecoin") != -1) || (id.toLowerCase().indexOf("auroracoin") != -1)) {  // Alt-coin
      if (getBooleanPreference("other-background")) {
        if (id.toLowerCase().indexOf("worldcoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.worldcoin;  
        } else if (id.toLowerCase().indexOf("dogecoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.dogecoin;  
        } else if (id.toLowerCase().indexOf("namecoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.namecoin;  
        } else if (id.toLowerCase().indexOf("auroracoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.auroracoin;  
        }
      }
    } else if (id.toLowerCase().indexOf("litecoin") != -1) {
        ...
        onComplete: function (response) {
          ...
          if ((response != null) && (response.json != null)) {
            ...
            for (var i = 0; i < json_path.length; i++) { // Parse JSON path
              if (typeof price[json_path[i]] == "undefined") {
