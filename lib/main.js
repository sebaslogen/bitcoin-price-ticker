...
tickers['MtGoxPLN'] = null;
tickers['BitcurexPLN'] = null;
tickers['MtGoxCAD'] = null;
tickers['CaVirTexCAD'] = null;
tickers['MtGoxJPY'] = null;
tickers['MtGoxCNY'] = null;
...
tickers['BittyliciousLitecoinGBP'] = null;
...
exports.main = function() {
  ...
  // USD prices //
  ticker_creators['MtGoxUSD'] = function() { return createTicker('MtGoxUSD', 'MtGox', '$', '#B43104', "https://data.mtgox.com/api/2/BTCUSD/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxUSD');

  ticker_creators['BitStampUSD'] = function() { return createTicker('BitStampUSD', 'BitStamp', '$', '#FF0000', "https://www.bitstamp.net/api/ticker/", ['last']); };
  registerEvents('BitStampUSD');

  ticker_creators['BTCeUSD'] = function() { return createTicker('BTCeUSD', 'BTCe', '$', '#FE642E', "https://btc-e.com/api/2/btc_usd/ticker", ['ticker','last']); };
  registerEvents('BTCeUSD');

  ticker_creators['KrakenUSD'] = function() { return createTicker('KrakenUSD', 'Kraken', '$', '#FF9966', "https://api.kraken.com/0/public/Ticker?pair=XBTUSD", ['result','XXBTZUSD','c',0]); };
  registerEvents('KrakenUSD');

  ticker_creators['CoinDeskUSD'] = function() { return createTicker('CoinDeskUSD', 'CoinDesk', '$', '#DBA901', "http://api.coindesk.com/v1/bpi/currentprice.json", ['bpi','USD','rate_float']); };
  registerEvents('CoinDeskUSD');

  ticker_creators['CoinbaseUSD'] = function() { return createTicker('CoinbaseUSD', 'Coinbase', '$', '#000066', "https://coinbase.com/api/v1/currencies/exchange_rates", ['btc_to_usd']); };
  registerEvents('CoinbaseUSD');

  ticker_creators['CampBXUSD'] = function() { return createTicker('CampBXUSD', 'CampBX', '$', '#000066', "http://campbx.com/api/xticker.php", ['Last Trade']); };
  registerEvents('CampBXUSD');

  ticker_creators['BitPayUSD'] = function() { return createTicker('BitPayUSD', 'BitPay', '$', '#FF0000', "https://bitpay.com/api/rates", [0,'rate']); };
  registerEvents('BitPayUSD');

  // Euro prices //
  ticker_creators['MtGoxEUR'] = function() { return createTicker('MtGoxEUR', 'MtGox', '\u20ac', '#807AE2', "https://data.mtgox.com/api/2/BTCEUR/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxEUR');

  ticker_creators['BTCeEUR'] = function() { return createTicker('BTCeEUR', 'BTCe', '\u20ac', '#013ADF', "https://btc-e.com/api/2/btc_eur/ticker", ['ticker','last']); };
  registerEvents('BTCeEUR');

  ticker_creators['KrakenEUR'] = function() { return createTicker('KrakenEUR', 'Kraken', '\u20ac', '#3366FF', "https://api.kraken.com/0/public/Ticker?pair=XBTEUR", ['result','XXBTZEUR','c',0]); };
  registerEvents('KrakenEUR');

  ticker_creators['CoinDeskEUR'] = function() { return createTicker('CoinDeskEUR', 'CoinDesk', '\u20ac', '#000066', "http://api.coindesk.com/v1/bpi/currentprice.json", ['bpi','EUR','rate_float']); };
  registerEvents('CoinDeskEUR');

  ticker_creators['BitPayEUR'] = function() { return createTicker('BitPayEUR', 'BitPay', '\u20ac', '#B43104', "https://bitpay.com/api/rates", [1,'rate']); };
  registerEvents('BitPayEUR');

  ticker_creators['BitonicEUR'] = function() { return createTicker('BitonicEUR', 'Bitonic', '\u20ac', '#B43104', "https://bitonic.nl/api/price", ['price']); };
  registerEvents('BitonicEUR');

  // Pound prices //
  ticker_creators['CoinDeskGBP'] = function() { return createTicker('CoinDeskGBP', 'CoinDesk', '\u00a3', '#088A08', "http://api.coindesk.com/v1/bpi/currentprice.json", ['bpi','GBP','rate_float']); };
  registerEvents('CoinDeskGBP');

  ticker_creators['LocalbitcoinsGBP'] = function() { return createTicker('LocalbitcoinsGBP', 'Localbitcoins', '\u00a3', '#088A08', "https://localbitcoins.com/bitcoinaverage/ticker-all-currencies/", ['GBP','rates','last']); };
  registerEvents('LocalbitcoinsGBP');

  ticker_creators['BittyliciousGBP'] = function() { return createTicker('BittyliciousGBP', 'Bittylicious', '\u00a3', '#088A08', "https://bittylicious.com/api/v1/quote/BTC/GB/GBP/BANK/1", ['totalPrice']); };
  registerEvents('BittyliciousGBP');

  ticker_creators['BitPayGBP'] = function() { return createTicker('BitPayGBP', 'BitPay', '\u00a3', '#FF0000', "https://bitpay.com/api/rates", [2,'rate']); };
  registerEvents('BitPayGBP');

  // Polish zloty //
  ticker_creators['MtGoxPLN'] = function() { return createTicker('MtGoxPLN', 'MtGox', 'z\u0141', '#B43104', "https://data.mtgox.com/api/2/BTCPLN/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxPLN');

  ticker_creators['BitcurexPLN'] = function() { return createTicker('BitcurexPLN', 'Bitcurex', 'z\u0141', '#B43104', "https://pln.bitcurex.com/data/ticker.json", ['last']); };
  registerEvents('BitcurexPLN');

  // Canadian dollar prices //
  ticker_creators['MtGoxCAD'] = function() { return createTicker('MtGoxCAD', 'MtGox', 'C$', '#B43104', "https://data.mtgox.com/api/2/BTCCAD/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxCAD');

  ticker_creators['CaVirTexCAD'] = function() { return createTicker('CaVirTexCAD', 'CaVirTex', 'C$', '#B43104', "https://www.cavirtex.com/api/CAD/ticker.json", ['last']); };
  registerEvents('CaVirTexCAD');

  // Yen prices //
  ticker_creators['MtGoxJPY'] = function() { return createTicker('MtGoxJPY', 'MtGox', '\u00a5', '#04B4AE', "https://data.mtgox.com/api/2/BTCJPY/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxJPY');

  // Yuan prices //
  ticker_creators['MtGoxCNY'] = function() { return createTicker('MtGoxCNY', 'MtGox', '\u5143', '#A901DB', "https://data.mtgox.com/api/2/BTCCNY/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxCNY');

  ticker_creators['BTCChinaCNY'] = function() { return createTicker('BTCChinaCNY', 'BTCChina', '\u5143', '#DF01D7', "https://data.btcchina.com/data/ticker", ['ticker','last']); };
  registerEvents('BTCChinaCNY');

  // Ruble prices //
  ticker_creators['BTCeRUR'] = function() { return createTicker('BTCeRUR', 'BTCe', 'RUR', '#4F3107', "https://btc-e.com/api/2/btc_rur/ticker", ['ticker','last']); };
  registerEvents('BTCeRUR');

  // Brazilian Real prices //
  ticker_creators['MercadoBitcoinBRL'] = function() { return createTicker('MercadoBitcoinBRL', 'MercadoBitcoin', 'R$', '#2F4F15', "https://www.mercadobitcoin.com.br/api/ticker/", ['ticker','last']); };
  registerEvents('MercadoBitcoinBRL');

  // Turkish Lira //
  ticker_creators['BTCTurkTRY'] = function() { return createTicker('BTCTurkTRY', 'BTCTurk', '\u20ba', '#5B5B2F', "https://www.btcturk.com/api/ticker", ['last']); };
  registerEvents('BTCTurkTRY');

  ticker_creators['LocalbitcoinsTRY'] = function() { return createTicker('LocalbitcoinsTRY', 'Localbitcoins', '\u20ba', '#088A08', "https://localbitcoins.com/bitcoinaverage/ticker-all-currencies/", ['TRY','rates','last']); };
  registerEvents('LocalbitcoinsTRY');

  // Venezuelan Bolivar //
  ticker_creators['BitcoinVenezuelaVEF'] = function() { return createTicker('BitcoinVenezuelaVEF', 'BitcoinVenezuela', 'Bs', '#672F7F', "http://bitcoinvenezuela.com/api/btcven.json", ['BTC','VEF']); };
  registerEvents('BitcoinVenezuelaVEF');

  ticker_creators['CoinbaseVEF'] = function() { return createTicker('CoinbaseVEF', 'Coinbase', 'Bs', '#4C285B', "https://coinbase.com/api/v1/currencies/exchange_rates", ['btc_to_vef']); };
  registerEvents('CoinbaseVEF');

  // Argentinian Peso //
  ticker_creators['BitcoinVenezuelaARS'] = function() { return createTicker('BitcoinVenezuelaARS', 'BitcoinVenezuela', 'ARS$', '#783489', "http://bitcoinvenezuela.com/api/btcven.json", ['BTC','ARS']); };
  registerEvents('BitcoinVenezuelaARS');

  ticker_creators['LocalbitcoinsARS'] = function() { return createTicker('LocalbitcoinsARS', 'Localbitcoins', 'ARS$', '#088A08', "https://localbitcoins.com/bitcoinaverage/ticker-all-currencies/", ['ARS','rates','last']); };
  registerEvents('LocalbitcoinsARS');

  ticker_creators['CoinbaseARS'] = function() { return createTicker('CoinbaseARS', 'Coinbase', 'ARS$', '#582266', "https://coinbase.com/api/v1/currencies/exchange_rates", ['btc_to_ars']); };
  registerEvents('CoinbaseARS');

  // Chilean Peso
  ticker_creators['LocalbitcoinsCLP'] = function() { return createTicker('LocalbitcoinsCLP', 'Localbitcoins', '$', '#088A08', "https://localbitcoins.com/bitcoinaverage/ticker-all-currencies/", ['CLP','rates','last']); };
  registerEvents('LocalbitcoinsCLP');

  // South African Rand //
  ticker_creators['BitXZAR'] = function() { return createTicker('BitXZAR', 'BitX', 'R', '#4A1F54', "https://bitx.co.za/api/1/BTCZAR/ticker", ['last_trade']); };
  registerEvents('BitXZAR');

  ticker_creators['CoinbaseZAR'] = function() { return createTicker('CoinbaseZAR', 'Coinbase', 'R', '#4A1F54', "https://coinbase.com/api/v1/currencies/exchange_rates", ['btc_to_zar']); };
  registerEvents('CoinbaseZAR');

  // Litecoin prices //
  ticker_creators['BTCeLitecoin'] = function() { return createTicker('BTCeLitecoin', 'BTCe', '\u0243', '#013ADF', "https://btc-e.com/api/2/ltc_btc/ticker", ['ticker','last']); };
  registerEvents('BTCeLitecoin');

  ticker_creators['VircurexLitecoin'] = function() { return createTicker('VircurexLitecoin', 'Vircurex', '\u0243', '#0B0B3B', "https://api.vircurex.com/api/get_last_trade.json?base=LTC&alt=BTC", ['value']); };
  registerEvents('VircurexLitecoin');

  ticker_creators['KrakenLitecoin'] = function() { return createTicker('KrakenLitecoin', 'Kraken', '\u0141', '#000066', "https://api.kraken.com/0/public/Ticker?pair=XBTLTC", ['result','XXBTXLTC','c',0]); };
  registerEvents('KrakenLitecoin');

  // Litecoin USD prices //
  ticker_creators['BTCeLitecoinUSD'] = function() { return createTicker('BTCeLitecoinUSD', 'BTCe', '$', '#413ADF', "https://btc-e.com/api/2/ltc_usd/ticker", ['ticker','last']); };
  registerEvents('BTCeLitecoinUSD');

  // Litecoin EUR prices //
  ticker_creators['BTCeLitecoinEUR'] = function() { return createTicker('BTCeLitecoinEUR', 'BTCe', '\u20ac', '#413ADF', "https://btc-e.com/api/2/ltc_eur/ticker", ['ticker','last']); };
  registerEvents('BTCeLitecoinEUR');

  // Litecoin GBP prices //
  ticker_creators['BittyliciousLitecoinGBP'] = function() { return createTicker('BittyliciousLitecoinGBP', 'Bittylicious', '\u00a3', '#088A08', "https://bittylicious.com/api/v1/quote/LTC/GB/GBP/BANK/1", ['totalPrice']); };
  registerEvents('BittyliciousLitecoinGBP');

  // WorldCoin prices //
  ticker_creators['VircurexWorldcoin'] = function() { return createTicker('VircurexWorldcoin', 'Vircurex', 'WDC', '#0B0B3B', "https://api.vircurex.com/api/get_last_trade.json?base=WDC&alt=BTC", ['value']); };
