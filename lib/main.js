...
exports.main = function() {
  ...
  var getBackgroundColor = function(id) {
    ...
    var other_bg_cryptos = [ 'dogecoin', 'worldcoin', 'namecoin', 'auroracoin', 'blackcoin', 'nxt',
      'bitshares', 'ripple', 'maidsafe', 'bitcoindark', 'monero', 'dash' ];
  ...
  // Dash prices //
  ticker_creators['CryptsyDashBTC'] = function() { return createTicker('CryptsyDashBTC', 'Cryptsy', '\u0243', 'DASH', '#000', "http://pubapi.cryptsy.com/api.php?method=singlemarketdata&marketid=155", ['return','markets','DRK','lasttradeprice']); };
  registerEvents('CryptsyDashBTC');
  ticker_creators['CryptsyDashUSD'] = function() { return createTicker('CryptsyDashUSD', 'Cryptsy', '$', 'DASH', '#000', "http://pubapi.cryptsy.com/api.php?method=singlemarketdata&marketid=213", ['return','markets','DRK','lasttradeprice']); };
  registerEvents('CryptsyDashUSD');
  ticker_creators['BitFinexDashBTC'] = function() { return createTicker('BitFinexDashBTC', 'BitFinex', '\u0243', 'DASH', '#000', "https://api.bitfinex.com/v1/ticker/drkbtc", ['last_price']); };
  registerEvents('BitFinexDashBTC');
  ticker_creators['BitFinexDashUSD'] = function() { return createTicker('BitFinexDashUSD', 'BitFinex', '$', 'DASH', '#000', "https://api.bitfinex.com/v1/ticker/drkusd", ['last_price']); };
  registerEvents('BitFinexDashUSD');
