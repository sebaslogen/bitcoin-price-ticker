...
tickers['PreludeDogecoin'] = null;
tickers['KrakenDogecoin'] = null;
tickers['PreludeDogecoinUSD'] = null;
tickers['KrakenDogecoinEUR'] = null;
tickers['BTCeNamecoinUSD'] = null;
tickers['CryptsyAuroracoin'] = null;
tickers['PreludeAuroracoin'] = null;
tickers['CryptsyBlackcoin'] = null;
tickers['MintPalBlackcoin'] = null;
tickers['CryptsyNxt'] = null;
tickers['BterNxt'] = null;
tickers['BterNxtUSD'] = null;
tickers['MintPalCloakcoin'] = null;
tickers['BterBitsharesX'] = null;
...
const CRYPTOCURRENCIES_BG_COLOR = {
  ...
  "nxt": 'nxt_background',
  "cloakcoin": 'cloak_background',
  "bitsharesx": 'btsx_background'
};
...
exports.main = function() {
  ...
  var getBackgroundColor = function(id) {
    ...
    if ((low_id.indexOf("worldcoin") != -1) || (low_id.indexOf("dogecoin") != -1) || 
        (low_id.indexOf("namecoin") != -1) || (low_id.indexOf("auroracoin") != -1) ||
        (low_id.indexOf("cloakcoin") != -1) || (low_id.indexOf("bitsharesx") != -1) ||
        (low_id.indexOf("blackcoin") != -1) || (low_id.indexOf("nxt") != -1)) {  // Alt-coin
      if (getBooleanPreference("other-background")) {
        if (low_id.indexOf("worldcoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.worldcoin;  
        } else if (low_id.indexOf("dogecoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.dogecoin;  
        } else if (low_id.indexOf("namecoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.namecoin;  
        } else if (low_id.indexOf("auroracoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.auroracoin;  
        } else if (low_id.indexOf("blackcoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.blackcoin;  
        } else if (low_id.indexOf("nxt") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.nxt;  
        } else if (low_id.indexOf("cloakcoin") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.cloakcoin;  
        } else if (low_id.indexOf("bitsharesx") != -1) {
          return CRYPTOCURRENCIES_BG_COLOR.bitsharesx;  
        }
      }
    } else if (low_id.indexOf("litecoin") != -1) {
      if (getBooleanPreference("silver-background")) { // Currency is Litecoin
        return CRYPTOCURRENCIES_BG_COLOR.litecoin;
      }
    } else { // Currency is Bitcoin
      if (getBooleanPreference("gold-background")){
          ...
          if ((response != null) && (response.json != null)) {
            ...
            for (var i = 0; i < ticker.json_path.length; i++) { // Parse JSON path
              if (typeof price[ticker.json_path[i]] == "undefined") {
                console.log("BitcoinPriceTicker error loading ticker " + id + ", URL not responding:" + ticker_url);
                return;
              }
  ...
  ticker_creators['BitPayUSD'] = function() { return createTicker('BitPayUSD', 'BitPay', '$', '\u0243', '#FF0000', "https://bitpay.com/api/rates", [0,'rate']); };
  registerEvents('BitPayUSD');

  ticker_creators['PreludeUSD'] = function() { return createTicker('PreludeUSD', 'Prelude', '$', '\u0243', '#6E307C', "https://api.prelude.io/last-usd/BTC", ['last']); };
  registerEvents('PreludeUSD');
  ...
  ticker_creators['BitPayEUR'] = function() { return createTicker('BitPayEUR', 'BitPay', '\u20ac', '\u0243', '#B43104', "https://bitpay.com/api/rates", [1,'rate']); };
  ...
  ticker_creators['BitPayGBP'] = function() { return createTicker('BitPayGBP', 'BitPay', '\u00a3', '\u0243', '#FF0000', "https://bitpay.com/api/rates", [2,'rate']); };
  registerEvents('BitPayGBP');

  // Polish zloty //
  ticker_creators['BitcurexPLN'] = function() { return createTicker('BitcurexPLN', 'Bitcurex', 'z\u0141', '\u0243', '#B43104', "https://pln.bitcurex.com/data/ticker.json", ['last']); };
  ...
  // Litecoin GBP prices //
  ticker_creators['BittyliciousLitecoinGBP'] = function() { return createTicker('BittyliciousLitecoinGBP', 'Bittylicious', '\u00a3', '\u0141', '#088A08', "https://bittylicious.com/api/v1/quote/LTC/GB/GBP/BANK/1", ['totalPrice']); };
  ...
  ticker_creators['PreludeDogecoin'] = function() { return createTicker('PreludeDogecoin', 'Prelude', '\u0243', 'DOGE', '#413ADF', "https://api.prelude.io/last/DOGE", ['last']); };
  registerEvents('PreludeDogecoin');

  // Dogecoin USD prices //
  ticker_creators['PreludeDogecoinUSD'] = function() { return createTicker('PreludeDogecoinUSD', 'Prelude', '$', 'DOGE', '#413ADF', "https://api.prelude.io/last-usd/DOGE", ['last']); };
  registerEvents('PreludeDogecoinUSD');

  // Dogecoin EUR prices //
  ticker_creators['KrakenDogecoinEUR'] = function() { return createTicker('KrakenDogecoinEUR', 'Kraken', 'DOGE', '\u20ac', '#000066', "https://api.kraken.com/0/public/Ticker?pair=ZEURXXDG", ['result','ZEURXXDG','c',0]); };
  registerEvents('KrakenDogecoinEUR');
  ...
  ticker_creators['PreludeAuroracoin'] = function() { return createTicker('PreludeAuroracoin', 'Prelude', '\u0243', 'AUR', '#413ADF', "https://api.prelude.io/last/AUR", ['last']); };
  registerEvents('PreludeAuroracoin');
  ...
  ticker_creators['MintPalBlackcoin'] = function() { return createTicker('MintPalBlackcoin', 'MintPal', '\u0243', 'BC', '#000', "https://api.mintpal.com/v1/market/stats/BC/BTC", [0,'last_price']); };
  registerEvents('MintPalBlackcoin');
  ...
  ticker_creators['BterNxt'] = function() { return createTicker('BterNxt', 'Bter', '\u0243', 'NXT', '#000', "http://data.bter.com/api/1/ticker/nxt_btc", ['last']); };
  registerEvents('BterNxt');

  ticker_creators['BterNxtUSD'] = function() { return createTicker('BterNxtUSD', 'Bter', '$', 'NXT', '#000', "http://data.bter.com/api/1/ticker/nxt_usd", ['last']); };
  registerEvents('BterNxtUSD');

  // Cloakcoin prices //
  ticker_creators['MintPalCloakcoin'] = function() { return createTicker('MintPalCloakcoin', 'MintPal', '\u0243', 'CLOAK', '#000', "https://api.mintpal.com/v1/market/stats/CLOAK/BTC", [0,'last_price']); };
  registerEvents('MintPalCloakcoin');

  // BitsharesX prices //
  ticker_creators['BterBitsharesX'] = function() { return createTicker('BterBitsharesX', 'Bter', '\u0243', 'BTSX', '#000', "http://data.bter.com/api/1/ticker/btsx_btc", ['last']); };
  registerEvents('BterBitsharesX');
