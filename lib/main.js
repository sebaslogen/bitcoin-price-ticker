...
var cryptocurrencies_bg_color = {
  "bitcoin": 'gold_background', 
  "litecoin": 'silver_background',
  "worldcoin": 'blue_background',
  "dogecoin": 'gold_background'
};

exports.main = function() {

  var isCryptocurrency = function(text) {
  ...
  var createTicker = function(id, label, currency, base_currency, color, ticker_url, json_path) {
    ...
    if ( isCryptocurrency(id) ) { // Litecoin can't have the gold Bitcoin background
    ...
    function updateTickerStyle() {
      ...
      var gold_background = getBooleanPreference("gold-background");
      var silver_background = getBooleanPreference("silver-background");
      if ( isCryptocurrency(id) ) { // Only Bitcoin can have the gold background
        gold_background = false;
      } else {
        silver_background = false; // Bitcoin can't have the silver Litecoin background
      }
