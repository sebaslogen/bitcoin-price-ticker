...
exports.main = function() {
  ...
  var getBackgroundColor = function(id) {
    if ((id.toLowerCase().indexOf("worldcoin") != -1) || (id.toLowerCase().indexOf("dogecoin") != -1) || (id.toLowerCase().indexOf("namecoin") != -1)) {  // Alt-coin
  ...
  // USD prices //
  ticker_creators['MtGoxUSD'] = function() { return createTicker('MtGoxUSD', 'MtGox', '$', '\u0243', '#B43104', "https://data.mtgox.com/api/2/BTCUSD/money/ticker", ['data','last','value']); };
  ...
  // Euro prices //
  ticker_creators['MtGoxEUR'] = function() { return createTicker('MtGoxEUR', 'MtGox', '\u20ac', '\u0243', '#807AE2', "https://data.mtgox.com/api/2/BTCEUR/money/ticker", ['data','last','value']); };
  ...
  // Polish zloty //
  ticker_creators['MtGoxPLN'] = function() { return createTicker('MtGoxPLN', 'MtGox', 'z\u0141', '\u0243', '#B43104', "https://data.mtgox.com/api/2/BTCPLN/money/ticker", ['data','last','value']); };
  ...
  ticker_creators['MtGoxCAD'] = function() { return createTicker('MtGoxCAD', 'MtGox', 'C$', '\u0243', '#B43104', "https://data.mtgox.com/api/2/BTCCAD/money/ticker", ['data','last','value']); };
  ...
  // Yen prices //
  ticker_creators['MtGoxJPY'] = function() { return createTicker('MtGoxJPY', 'MtGox', '\u00a5', '\u0243', '#04B4AE', "https://data.mtgox.com/api/2/BTCJPY/money/ticker", ['data','last','value']); };
  registerEvents('MtGoxJPY');

  // Yuan prices //
  ticker_creators['MtGoxCNY'] = function() { return createTicker('MtGoxCNY', 'MtGox', '\u5143', '\u0243', '#A901DB', "https://data.mtgox.com/api/2/BTCCNY/money/ticker", ['data','last','value']); };
