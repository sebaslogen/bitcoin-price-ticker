...
exports.main = function() {
  ...
  // Argentinian Peso //
  ticker_creators['BitcoinVenezuelaARS'] = function() { return createTicker('BitcoinVenezuelaARS', 'BitcoinVenezuela', 'ARS$', '#6E307C', "http://bitcoinvenezuela.com/api/btcven.json", ['BTC','ARS']); };
  registerEvents('BitcoinVenezuelaARS');

  ticker_creators['CoinbaseARS'] = function() { return createTicker('CoinbaseARS', 'Coinbase', 'ARS$', '#4A1F54', "https://coinbase.com/api/v1/currencies/exchange_rates", ['btc_to_ars']); };
